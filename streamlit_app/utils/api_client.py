...
# Shared secret for calling the Python RAG API. Must match RAG_API_KEY on the
# server. Sent as the X-API-KEY header on every RAG request.
...
def document_upload_rag(file, description: str, session_id: str) -> bool:
    ...
    Args:
        ...
        session_id: Session identifier, so the document is scoped to this user.
